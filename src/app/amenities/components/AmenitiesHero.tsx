...
export default function AmenitiesHero() {
  return (
    <section className="relative h-[70vh] sm:h-[70vh] md:h-[100vh] bg-cover bg-center bg-[url('/ResizedImages/EMBRACE_THE_WIND_26.jpg')]">
      <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center px-4 text-center">
        ...
        <p className="mt-4 max-w-2xl text-lg text-white/80">
          Discover premium amenities designed to elevate your lifestyle every day.
        </p>
      </div>
    </section>
  );
