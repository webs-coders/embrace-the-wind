...
const Footer: React.FC = () => {
  ...
  const approvalLogos = [
    { name: 'CREDAI', src: 'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&cs=tinysrgb&w=100&h=60', alt: 'CREDAI Approved' },
    { name: 'NPR', src: 'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&cs=tinysrgb&w=100&h=60', alt: 'NPR Certified' },
    { name: 'WBRERA', src: 'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&cs=tinysrgb&w=100&h=60', alt: 'WBRERA Registered' }
  ];

  const bankLogos = [
    { name: 'ICICI Bank', src: 'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&cs=tinysrgb&w=100&h=50', alt: 'ICICI Bank' },
    { name: 'Axis Bank', src: 'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&cs=tinysrgb&w=100&h=50', alt: 'Axis Bank' },
    { name: 'Yes Bank', src: 'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&cs=tinysrgb&w=100&h=50', alt: 'Yes Bank' },
    { name: 'Kotak Bank', src: 'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&cs=tinysrgb&w=100&h=50', alt: 'Kotak Bank' }
  ];
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {/* Site Address */}
            <div>
              <h3 className="font-bold text-lg text-gold-400 mb-4">SITE ADDRESS</h3>
            ...
            {/* Approval Logos */}
            <div>
              <h4 className="font-semibold text-white mb-4">Project Approved By</h4>
              <div className="grid grid-cols-3 gap-3">
                {approvalLogos.map((logo, index) => (
                  <div key={index} className="bg-white/10 rounded-lg p-2 hover:bg-white/20 transition-colors duration-300">
            ...
            {/* Bank Logos */}
            <div>
              <h4 className="font-semibold text-white mb-4">Project Financed by and Mortgaged to Bajaj Housing Finance Ltd.</h4>
            ...
            <div className="text-xs text-white/60">
              <p>RERA Registration Number: WBRERA/P/KOL/2023/000146</p>
            </div>
          </div>
            ...
            <nav className="space-y-3">
              {navigationLinks.map((link, index) => (
                <a
                  key={index}
                  href={link.href}
                  className="block text-white/80 hover:text-gold-400 hover:translate-x-2 transition-all duration-300 text-sm"
                >
                  {link.title}
                </a>
              ))}
                ...
                <div className="flex space-x-4">
                  {socialLinks.map(({ icon: Icon, href, label }, index) => (
                    <a
                      key={index}
                      href={href}
                      className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center text-white hover:bg-gold-500 hover:scale-110 transition-all duration-300 group"
                      aria-label={label}
                    >
