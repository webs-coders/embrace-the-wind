...
const ContactDetails: React.FC = () => {
  return (
    <div className="bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-xl border border-gray-200 max-w-3xl mx-auto">
      <h2 className="text-3xl md:text-4xl font-semibold text-color-orange mb-8 border-l-4 border-color-orange pl-4">
        Contact Us
      </h2>

      <div className="space-y-8 text-gray-800">
        <div className="flex items-start gap-5">
          <div className="bg-color-light-orange text-white p-3 rounded-xl">
